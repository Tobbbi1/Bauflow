-- Bauflow Migration Script - Ultra-sicherer Update für bestehende Datenbank
...
-- Drop ALL existing policies (sicher)
DO $$ 
DECLARE 
    r RECORD;
BEGIN
    ...
    -- Drop policies for time_entries
    ...
    -- Drop policies for project_materials
    ...
    -- Drop policies for employee_invitations
